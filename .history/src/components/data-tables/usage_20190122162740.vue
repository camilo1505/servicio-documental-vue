  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        <td color="primary" v-if="props.item.estado" >Publico<v-icon small color="black">lock_open</v-icon>{{props.item.estado}}</td>
        <td  v-else><v-icon small>lock</v-icon>{{props.item.estado}}</td>
