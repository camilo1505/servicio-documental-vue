                        ...
                        <v-container style="position: relative;top: 13%;" class="text-xs-center">
                            <v-card flat>
                                ...
                                <v-form>
                                    ...
                                    <v-text-field v-model="comprobarPass" prepend-icon="lock" label="Comprovar Contraseña" type="password" required></v-text-field>
                                    <v-card-actions>
                                        <v-btn primary large block @click="guardarUsuario() " v-if="usuarioDTO.password == comprobarPass">Registrarse</v-btn>
