                        ...
                        <v-container style="position: relative;top: 13%;" class="text-xs-center">
                            <v-card flat>
                                ...
                                <v-form>
                                    ...
                                    <v-text-field v-model="comprovarPass" prepend-icon="lock" label="Comprovar Contraseña" type="password"></v-text-field>
                                    <v-card-actions>
                                        <v-btn primary large block @click="comprobarUsuario()">Guardar</v-btn>
                                        <v-btn primary large block @click="cerrarSecion()">Cancelar</v-btn>
