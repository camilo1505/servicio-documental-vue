  ...
  <div>
    ...
    >
      ...
      <template slot="items" slot-scope="props">
        <td v-if="props.item.estado"> <v-btn color="blue lighten-5">Publico <v-icon>lock_open</v-icon></v-btn> </td>
        <td v-else-if="props.item.estado===false && propietario(props.item)"> <v-btn color="lime lighten-5">Privado <v-icon>lock</v-icon></v-btn> </td>
