  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        <td v-if="props.item.estado" ><v-icon small>account</v-icon>{{props.item.estado}}</td>
        <td v-if="props.item.estado===false"><v-icon small>account</v-icon>{{props.item.estado}}</td>
