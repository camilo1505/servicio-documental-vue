  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        <td class="deshabilitado" v-if="props.item.estado" ><v-icon small color="black">lock_open</v-icon>{{props.item.estado}}</td>
        <td class="deshabilitado" v-if="props.item.estado===false"><v-icon small>lock</v-icon>{{props.item.estado}}</td>
