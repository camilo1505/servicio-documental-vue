  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        <td class="publico" v-if="props.item.estado && propietario(props.item)" >Publico <v-icon small color="black">lock_open</v-icon></td>
        <td class="privado" v-if="props.item.estado===false && propietario(props.item)">Privado <v-icon small>lock</v-icon></td>
        ...
        <td v-if="propietario(props.item)">
        <v-edit-dialog
        ...
        <td v-if="propietario(props.item)" class="text-xs-right">{{ props.item.usuario }}</td>
        <td v-if="propietario(props.item)">
          <v-chip 
        ...
        <td v-if="propietario(props.item)" class="text-xs-left">
          <v-icon
            small
