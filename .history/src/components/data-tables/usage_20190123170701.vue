    ...
    >
      ...
      <template slot="items" slot-scope="props">
        <td v-if="props.item.estado" >
         <v-btn color="blue lighten-5" v-model="editedItem.estadoEdit" @click="props.item.estado=false,editedItem.estadoEdit=false">Publico <v-icon>lock_open</v-icon></v-btn> 
          </td>
        <td  v-else-if="props.item.estado===false && propietario(props.item)" @click="props.item.estado=true,editedItem.estadoEdit=true"> <v-btn v-model="editedItem.estadoEdit" color="lime lighten-5">Privado <v-icon>lock</v-icon></v-btn> </td>
