  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props" v-if="documentos">
        <td v-if="props.item.estado=true" ><v-icon small>lock open</v-icon> {{props.item.estado}} </td>
        <td v-if="props.item.estado=false"><v-icon small>lock open</v-icon> {{props.item.estado}} </td>
        <td>
        <v-edit-dialog
