  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props">
        <td v-if="props.item.estado" ><v-icon small color="darken">lock_open</v-icon>{{props.item.estado}}</td>
        <td v-if="props.item.estado===false"><v-icon small>lock</v-icon>{{props.item.estado}}</td>
