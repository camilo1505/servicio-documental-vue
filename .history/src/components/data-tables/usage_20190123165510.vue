  ...
  <div>
    ...
    >
      ...
      <template slot="items" slot-scope="props">
        ...
        <td v-else-if="props.item.estado===false && propietario(props.item)" @click="props.item.estado=true,,estadoEdit=true"> <v-btn color="lime lighten-5">Privado <v-icon>lock</v-icon></v-btn> </td>
