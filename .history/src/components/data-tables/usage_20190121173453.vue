  ...
  <div>
    ...
    >
      <template slot="items" slot-scope="props" >
        <td :key="props.item.id.counter" >{{props.item.id.counter}}</td>
        <td  class="text-xs-left" :key="props.item.id.counter">{{ props.item.nombre }}</td>
        <td class="text-xs-right" :key="props.item.id.counter">{{ props.item.descripcion }}</td>
        <td class="text-xs-right" :key="props.item.id.counter">{{ props.item.usuario }}</td>
        <td class="text-xs-right" :key="props.item.id.counter">{{ props.item.etiquetas }}</td>
