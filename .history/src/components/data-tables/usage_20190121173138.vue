<template>
  ...
  <div>
    ...
    >
      <template >
        <div v-for="(item, i) in documentos" :key="`${i}-${item.id}`">
          <td>{{item.id.counter}}</td>
        <td class="text-xs-left">{{ item.nombre }}</td>
        <td class="text-xs-right">{{ item.descripcion }}</td>
        <td class="text-xs-right">{{ item.usuario }}</td>
        <td class="text-xs-right">{{ item.etiquetas }}</td>
