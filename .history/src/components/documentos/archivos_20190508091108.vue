    ...
    data () {
        ...
        methods: {
            ...
            editarArchivo(archivo) {
                Axios
                .put("http://localhost:8080/documento/editarArchivo?usuario=" + this.localStorage.user "&documento=" + this.shareName + "&nombreActual=" + archivo.nombreArchivo + "&nombreNuevo="+ this.nuevoNombre + "&usuario=" + localStorage.user)
                .then(Response => (this.estadoSolicitud = Response.status))
