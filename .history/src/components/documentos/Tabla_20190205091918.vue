<template>
    <div>
        ...
        <template slot="items" slot-scope="props">
            ...
            <td>
            <div>            
                <td class="text-xs-left" v-if="props.item.estado"><v-icon  @click="cambiarEstado(props.item)" >lock_open</v-icon></td>
                <td class="text-xs-left" v-else><v-icon  @click="cambiarEstado(props.item)">lock</v-icon></td>
