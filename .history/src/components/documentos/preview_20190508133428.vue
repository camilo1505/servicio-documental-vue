      ...
      <v-card>
        ...
        <v-card-text>
          <div class="embed-container" v-if="frame">
            <iframe width="1200" height="1000" :src="'/'+url" frameborder="0" allowfullscreen></iframe>
          </div>
          <form>
            <v-btn
            dark
...
<script>
  ...
  export default {
    ...
    const type = this.url.split(".");
      ...
      Axios.get("/documento/guardarArchivo?nombreDocumento="+documento.nombre+"&usuario="+documento.usuario, formData, {
