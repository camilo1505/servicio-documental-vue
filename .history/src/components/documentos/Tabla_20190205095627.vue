<template>
    <div>
        ...
        <template slot="items" slot-scope="props">
            ...
            <td>
                <v-icon flat v-if="props.item.estado" @click="cambiarEstado(props.item)" >lock_open</v-icon>
                <v-icon flat v-if="!props.item.estado"  @click="cambiarEstado(props.item)">lock</v-icon>
                <archivos flat  @cambioDocumentos="documentos = $event" :shareDocs = "props.item.archivo" :shareUser = "props.item.usuario" :shareName = "props.item.nombre"></archivos>
