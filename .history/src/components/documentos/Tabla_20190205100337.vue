    ...
    <div>
        ...
        <template slot="items" slot-scope="props">
            ...
            <td>
                ...
                <v-icon small class="mr-2" @click="dialog=true">visibility</v-icon>
                <archivos :dialog="dialog" @cambioDocumentos="documentos = $event" :shareDocs = "props.item.archivo" :shareUser = "props.item.usuario" :shareName = "props.item.nombre"></archivos>
                <v-icon  small class="mr-2" v-if="props.item.usuario === usuario" @click="eliminarDocumento(props.item)" > delete </v-icon>
            </td>
        </template>
        </v-data-table>
