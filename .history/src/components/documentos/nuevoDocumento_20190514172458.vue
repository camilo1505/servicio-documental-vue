<template>
    <v-dialog v-model="dialogo" max-width="700px" persistent>
        ...
        <v-card>
            ...
            <v-card-actions>
                <v-spacer></v-spacer>
                <v-btn color="blue darken-1" flat @click="guardarDocumento()">Cancelar</v-btn>
            </v-card-actions>
...
export default {
    ...
    methods: {
        ...
        cargarDocumentos() {
            Axios
            .get("/documento/consultar?consulta=&usuario=" + localStorage.user + "&etiqueta=&misDocumentos=" + this.misDocumentos)
