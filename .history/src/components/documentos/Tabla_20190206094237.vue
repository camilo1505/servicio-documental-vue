        ...
        <v-app>
                ...
                <template slot="items" slot-scope="props">
                    ...
                    <td class="justify-center layout px-0">
                        ...
                        <archivos :shareDocs = "props.item.archivo" :shareUser = "props.item.usuario" :shareName = "props.item.nombre"></archivos>
...
export default {
    ...
    methods: {
      ...
      borrar (documento) {
        Axios
        .put("http://localhost:8080/documento/eliminarDocumento?nombreDocumento=" + documento.nombre + "&usuario=" + localStorage.user)
      ...
      editarDocumento(documento){
            Axios
            .put("http://localhost:8080/documento/editarDocumento", documento)
            .then(Response => (this.estadoSolicitud = Response.status))
        },
