        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="documento in documentos" :key="documento.id.counter">
                    ...
                    <td><button @click="showEditarDocumento=true" class="btn btn-secondary btn-sm" type="button"><i class="fa fa-cogs" aria-hidden="true"></i> Editar</button></td>
                                    ...
                                    <div class="modal-wrapper">
                                        <div class="modal-container">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button class="modal-default-button" @click="">
                                                    acepto
                                                </button>
                                                </slot>
                                            </div>
