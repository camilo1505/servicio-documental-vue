        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="documento in documentos" :key="documento.nombre">
                    ...
                    <td>
                        <button  class="btn btn-secondary btn-sm" v-on:click="filtrarDocumentos(documento)" type="button"><i class="fa fa-archive" aria-hidden="true"></i> Ver los archivos</button>
                    </td>
                    <td>
