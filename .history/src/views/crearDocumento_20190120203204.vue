        ...
        <div class="col-lg-4">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    <table>
                        <tr>
                            <td class = "text-left">Borrador <input type="radio" id="borrador" value="borrador" name="estado" v-model="documentoDTO.estado"></td>
                            <td class = "text-left">Publicado <input type="radio" id="publicado" value="publicado" name="estado" v-model="documentoDTO.estado"></td>
                        </tr>
                    </table>
                </div>
                <div class="row">
