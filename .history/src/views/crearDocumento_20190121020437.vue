    ...
    data() {
        ...
        methods: {
            crearDocumento(){
                ...
                documentoDTO.nombre=this.nombre
                documentoDTO.descripcion = this.descripcion
                documentoDTO.estado = this.estado
                documentoDTO.etiquetas = this.tags
                documentoDTO.archivo = this.archivos
            }
        }
}
</script>