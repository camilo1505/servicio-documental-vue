                                        ...
                                        <slot name="body">
                                            ...
                                            <tbody>
                                                <tr v-for="archivo in archivos" :key="archivo.nombreArchivo">
                                                    ...
                                                    <td>
                                                        <button @click="eliminarArchivo(),eliminarDocumento=documento" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-trash" aria-hidden="true"></i> Borrar </button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>                
...
export default {  
    ...
    methods: {
        ...
        eliminarArchivo(documento,archivo){
            ...
            axios
            .post("http://localhost:8080/api/v1/documento/eliminarArchivo?archivo="+this.archivoEliminar.url,this.documento)
