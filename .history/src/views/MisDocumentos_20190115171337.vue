                                                ...
                                                <slot name="body">
                                                    <table class="table">
                                                        <tr>
                                                            ...
                                                            <td><input class="input" v-model="nuevoNombre" type="text" placeholder="nombre del documento" ></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input v-model="descripcion" type="text" placeholder="descripcion" ></td>
                                                        </tr>
                                                        <tr>
                                                            <td><h4>estado</h4></td>
                                                            <td><input v-model="estado" type="checkbox" placeholder="Estado del documento" ></td>
                                                        </tr>
                                                    </table>
