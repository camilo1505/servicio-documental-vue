<template>
    <div v-if="documentos">
        ...
        <form>
            <div class="row">
                <div class="col">
                    <input type="text" class="form-control" placeholder="Nombre Documento" id="nombreDocumento">
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Autor" id="autor">
                </div>
                <div class="col">
                    <input type="text" class="form-control" placeholder="Tags" id="etiquetas">
                </div>
                <div class="col">
                    <button @click="filtrarDocumentos()" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                </div>
            </div>
        </form>
        <br>
