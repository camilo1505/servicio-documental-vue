                                                ...
                                                <slot name="body">
                                                    <table class="table">
                                                        <tr>
                                                            ...
                                                            <td><input class="form-control" v-model="nuevoNombre" value="this.nuevoNombre" type="text" placeholder="nombre del documento" ></td>
                                                        </tr>
                                                        <tr>
...
export default {  
    ...
    methods: {
        ...
        editarDocumento(){
            ...
            this.estado = this.editarDocumento.estado
        }
    },
