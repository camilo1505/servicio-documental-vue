    ...
    <div class="container" >
        <div class="col-lg-5">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    <textarea class="form-control" rows="4" placeholder="Descripcion" v-model="documentoDTO.descripcion"></textarea>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="file-field">
                        <div class="btn btn-primary btn-sm float-left">
                            <input type="file" v-on:change="archivo">
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    data() {
        ...
        methods: {
            crearDocumento(){
                this.documentoDTO.etiquetas = this.tags
                this.documentoDTO.archivos = []
                Axios
                .post("http://localhost:8080/api/v1/documento/crearDocumento",this.documentoDTO)
                .then(Response => (this.documentos = Response.data))
                Axios
                .get("http://localhost:8080/api/v1/documento/guardarArchivo?nombreArchivo" + this.documentoDTO.nombre+"&autor="+this.documentoDTO.usuario,"file")
                .then(Response => (this.documentos = Response.data))
            },
            redireccionar(){
