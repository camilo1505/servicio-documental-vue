    ...
    <div class="container">
        ...
        <div class="col-lg-4">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="Autor" v-model="documentoDTO.autor">
                </div>
                <div class="form-group">
                    <input type="textarea" class="form-control" placeholder="Descripcion" v-model="documentoDTO.descripcion">
                </div>
                <button class="btn btn-primary form-control">Login</button>
            </div>
            <button v-if="consultaValida(respuesta)" type="button" class="btn btn-success">Acceder</button>
        </div>
        <div class="col-lg-4"></div>
    </div>
</template>
