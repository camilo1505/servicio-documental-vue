        ...
        <div class="col-lg-4">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    <table>
                        <tr>
                            <td >Borrador <i class="fa fa-unlock-alt" aria-hidden="true"></i> <input type="radio" id="borrador" value="borrador" name="estado" v-model="documentoDTO.estado"></td>
                        </tr>
                        <tr>
                            <td >Publicado <i class="fa fa-unlock" aria-hidden="true"></i> <input type="radio" id="publicado" value="publicado" name="estado" v-model="documentoDTO.estado"></td>
                        </tr>
                    </table>
                </div>
                <div class="row">
