    ...
    <div class="container">
        ...
        <div class="col-lg-4">
            <div class="jumbotron">
                ...
                <div class="form-group">
                    <label class="radio-inline"><input type="radio" name="optradio" checked>Borrador</label>
                    <label class="radio-inline"><input type="radio" name="optradio" checked>Publicado</label>
                </div>
