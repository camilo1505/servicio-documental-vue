                                        ...
                                        <slot name="body">
                                            ...
                                            <tbody>
                                                <tr v-for="archivo in archivos" :key="archivo.nombreArchivo">
                                                    ...
                                                    <td>
                                                        <button @click="eliminarArchivo(documento,archivo.url),eliminarDocumento=documento" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-trash" aria-hidden="true"></i> Borrar </button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>                
