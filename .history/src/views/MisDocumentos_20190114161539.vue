        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="documento in documentos" :key="documento.nombre">
                    ...
                    <td>
                        <button @click="verArchivos(documento)" button id="show-modal" @click="showModal = true" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-archive" aria-hidden="true"></i> Ver Archivos</button>
                    </td>
                    <td>
