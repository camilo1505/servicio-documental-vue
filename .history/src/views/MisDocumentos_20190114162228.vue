                ...
                <div class="modal-wrapper">
                    ...
                    <div class="modal-body">
                        <slot name="body">
                            ...
                            <tbody>
                                <tr v-for="archive in archivos" :key="archivo.nombreArchivo">
                                    <td scope="row">
                                        <i class="fa fa-folder" aria-hidden="true"></i>
                                    </td>
                                    ...
                                    <td> {{ archivo.url }} </td>
                                    <td>
                                        <button @click="" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-archive" aria-hidden="true"></i> Ver Archivos</button>
                                    </td>
                                    <td>
                                        <button class="btn btn-secondary btn-sm" type="button"><i class="fa fa-cogs" aria-hidden="true"></i> Editar</button>
                                    </td>
