                                    ...
                                    <div class="modal-wrapper">
                                        <div class="modal-container">
                                            ...
                                            <div class="modal-body">
                                                <slot name="body">
                                                    <label for=""><input v-model="nuevoNombre" type="text" placeholder="nombre del documento" ></label>
                                                    <label for=""><input v-model="etiquetas" type="text" placeholder="etiquetas" ></label>
                                                    <label for=""><input v-model="descripcion" type="text" placeholder="descripcion" ></label>
                                                    <label for=""><input v-model="estado" type="checkbox" placeholder="Estado del documento" ></label>
