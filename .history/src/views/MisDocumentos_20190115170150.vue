                                        ...
                                        <div class="modal-container">
                                            ...
                                            <div class="modal-body">
                                                <slot name="body">
                                                    <table class="table">
                                                        <td>
                                                            <tr><h4>Nombre del documento</h4></tr>
                                                            <tr><h4>etiquetas</h4></tr>
                                                            <tr><h4>descripcion</h4></tr>
                                                            <tr><h4>estado</h4></tr>
                                                        </td>
                                                        <td>
                                                            <tr><input v-model="nuevoNombre" type="text" placeholder="nombre del documento" ></tr>
                                                            <tr><input v-model="etiquetas" type="text" placeholder="etiquetas" ></tr>
                                                            <tr><input v-model="descripcion" type="text" placeholder="descripcion" ></tr>
                                                            <tr><input v-model="estado" type="checkbox" placeholder="Estado del documento" ></tr>
                                                        </td>
                                                    </table>
