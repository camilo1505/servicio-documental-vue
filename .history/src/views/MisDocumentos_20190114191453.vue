        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr v-for="documento in documentos" :key="documento.id.machineIdentifier">
                    ...
                    <td>
                        <button @click="deleteDocumento(documento),showBorrarDocumento=true" class="btn btn-secondary btn-sm"  type="button"><i class="fa fa-trash" aria-hidden="true"></i> Borrar </button>
                    </td>
