                                                ...
                                                <slot name="body">
                                                    <table class="table">
                                                        <tr>
                                                            ...
                                                            <td><input class="form-control" v-model="nuevoNombre" value="nuevoNombre" type="text" placeholder="nombre del documento" ></td>
                                                        </tr>
                                                        <tr>
...
export default {  
    ...
    methods: {
        ...
        editarDocumentos(){
            this.nuevoNombre = this.documento.nombre
            this.descripcion = this.documento.descripcion
            this.etiquetas = this.documento.etiquetas
