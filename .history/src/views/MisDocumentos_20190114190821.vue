    ...
    <div v-if="documentos">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <div v-if="archivos">
                        <transition name="verArchivos">
                            <div class="verArchivos-mask">
                            <div class="verArchivos-wrapper">
                                <div class="verArchivos-container">

                                <div class="verArchivos-header">
                                    <slot name="header">
                                    Archivos del documento
                                    </slot>
                                </div>

                                <div class="verArchivos-body">
                                    <slot name="body">
                                        <table class="table table-hover">
                                        <thead class="thead-light">
                                            <tr>
                                ...
                                <div class="verArchivos-footer">
                                    <slot name="footer">
                                    <button class="verArchivos-default-button" @click="archivos=null">
                                        OK
                                    </button>
                                    </slot>
                                </div>
