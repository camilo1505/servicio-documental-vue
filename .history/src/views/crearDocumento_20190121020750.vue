...
export default {
    ...
    data() {
        ...
        methods: {
            crearDocumento(){
                this.documentoDTO.nombre=this.nombre
                this.documentoDTO.descripcion = this.descripcion
                this.documentoDTO.estado = this.estado
                this.documentoDTO.etiquetas = this.tags
                this.documentoDTO.archivo = this.archivos
            }
        }
}
</script>